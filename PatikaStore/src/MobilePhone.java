public class MobilePhone {
    ...
    public MobilePhone(int _id, double _price, int _discountRate, int _stock, String _name, int _brandId, int _memorySize, double _screenSize, int _ramSize, int _batterySize, ColorEnum _color) {
        this._id = _id;
        this._price = _price;
        ...
        this._batterySize = _batterySize;
        this._color = _color;
    }
    ...
    public int get_batterySize() {
        return _batterySize;
    }

    public void set_batterySize(int _batterySize) {
        this._batterySize = _batterySize;
    }
